...
\input{capitulos/2_fundamentacao.tex}
\input{capitulos/3_taxonomia.tex}
\input{capitulos/4_problemas_bipartido/problemas.tex}
\input{capitulos/5_problemas_gerais/problemas.tex}
\input{capitulos/6_trabalhos_futuros.tex}
