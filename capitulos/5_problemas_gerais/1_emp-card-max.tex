...
\begin{table}[ht]
    \centering
    \caption{Algoritmos para problema de emparelhamento de cardinalidade máxima em grafos gerais}
    \label{tab:emp_card_max_geral_algos}
    ...
    \begin{tabularx}{\textwidth}{@{} l l l X @{}}
        ...
        Edmonds & $O(V^3)$ & Exato & 
        Algoritmo exato (Blossom) que contrai ciclos ímpares temporariamente em super-vértices para identificar caminhos aumentantes. \\
        \addlinespace 
        ...
        Heurística linear que constrói caminhos simples via DFS e seleciona arestas alternadas para garantir um emparelhamento maximal. \\
