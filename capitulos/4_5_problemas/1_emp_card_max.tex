...
O algoritmo de Edmonds-Karp, que foi definido na seção \ref{p:edmonds-karp} é o padrão para resolver o problema de fluxo máximo, utilizando buscas em largura (BFS) para encontrar caminhos aumentantes na rede residual.
